...
const ArticlePreviewTag = ({ children }: { children?: any }) => (
        <h6 class="text_line-height_m text_size_l text_weight_xbold text_style_small-caps text_letter-spacing_m article-preview__tags">
                {children}
        </h6>
);
...
const ArticlePreviewSubtitle = ({ children }: { children?: any }) => (
        <h5 class="text_line-height_m text_size_m text_weight_medium article-preview__subtitle">
                {children}
        </h5>
);
...
const ArticlePreviewDate = ({
        ...
        <p class="text_line-height_m text_size_s text_weight_regular text_style_small-caps text_letter-spacing_m article-preview__date">
                {date.split("-").join("/")}
        </p>
);
