...
export const Telegram = ({ classes }: { classes: string }) => (
        <svg
...
export const Email = ({ classes }: { classes: string }) => (
        <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="24px"
...
export const Github = ({ classes }: { classes: string }) => (
        <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
...
export const Twitter = ({ classes }: { classes: string }) => (
        <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
